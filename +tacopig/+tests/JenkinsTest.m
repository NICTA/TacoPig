% Tacopig testing structure to represent a single test case in a suite.
% prints to a component of an XML reports summarising the outcomes of the 
% test case including name, whether the test was skipped and the nature of 
% any errors or test failures.
